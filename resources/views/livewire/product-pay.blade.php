        ...
        <div class="card-body">
            ...
            <form id="card-form">
                ...
                <div class="form-group">
                    <label for="form-label">Nombre de la tarjeta</label>
                    <input class="form-control" id="card-holder-name" type="text"
                        placeholder="Ingrese el nombre del títular de la tarjeta" required>
                </div>
    ...
    @slot('js')
        ...
        <script>
            ...
            Livewire.on('errorPayment',function(){
                ...
                alert('Hubo un error en la compra, inténtelo de nuevo')
            })
        </script>
